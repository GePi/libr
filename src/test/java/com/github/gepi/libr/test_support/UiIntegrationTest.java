package com.github.gepi.libr.test_support;

import com.github.gepi.libr.LibrApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.libr.screen")
@ContextConfiguration(classes = {LibrApplication.class, UiTestAssistConfiguration.class})
